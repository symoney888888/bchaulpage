                ...
                <div class="wrap">
                    <div class="formArea">
                        ...
                        <div class="formContain">
                            ...
                            <div class="formRow">
                                <div class="formItem"><span>公司/姓名：</span><input v-model="formData.name" /></div>
                                <div class="formItem"><span>車牌號碼：</span><input v-model="formData.car_plate_number" /></div>
                            </div>
                            <div class="formRow">
                                <div class="formItem"><span>聯繫電話：</span><input v-model="formData.phone" /></div>
                                <div class="formItem">
                                    <span>車輛品牌：</span>
                            ...
                            <div class="formRow">
                                <div class="formItem"><span>電子信箱：</span><input v-model="formData.email" /></div>
                                <div class="formItem">
                                    <span>車輛型號：</span>
                                    <select name="camry" class="camry" v-model="formData.car_camry">
                                        <option value=""><label>- Select -</label></option>
                                        <option v-for="(item, index) in car_camryList" :key="index" :value="item">{{ item }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="formRow">
                                <div class="formItem"><span>地址：</span><input v-model="formData.name_address" /></div>
                                <div class="formItem">
                                    <span>車輛顏色：</span>
                            ...
                            <div class="formRow">
                                <div class="formItem"><span>起運地址：</span><input v-model="formData.departure_address" /></div>
                                <div class="formItem"><span>目的地地址：</span><input v-model="formData.destination_address" /></div>
                            </div>
                            <div class="formRow">
